...
namespace Nova
{
    ...
    public:
        ...
        Border(sf::Vector2f pos, sf::Vector2f size, float outline_thickness)
        {
            ...
            mVertex[1].position = sf::Vector2f(pos.x + outline_thickness, pos.y + outline_thickness);
            mVertex[2].position = sf::Vector2f(pos.x + size.x, pos.y);
            mVertex[3].position = sf::Vector2f(pos.x + size.x - outline_thickness, pos.y + outline_thickness);
            mVertex[4].position = sf::Vector2f(pos.x + size.x, pos.y + size.y);
            mVertex[5].position = sf::Vector2f(pos.x + size.x - outline_thickness, pos.y + size.y - outline_thickness);
            mVertex[6].position = sf::Vector2f(pos.x, pos.y + size.y);
            mVertex[7].position = sf::Vector2f(pos.x + outline_thickness, pos.y + size.y - outline_thickness);
            mVertex[8].position = pos;
            mVertex[9].position = sf::Vector2f(pos.x + outline_thickness, pos.y + outline_thickness);
        }
        virtual ~Border() {}
