...
gui::TextBox::TextBox(sf::Vector2f position, sf::Vector2f size, sf::Font &font, std::string placeholder, unsigned character_size, unsigned character_limit, bool multiline)
    : text(font, "", character_size), placeholderText(font, placeholder, character_size)
{
