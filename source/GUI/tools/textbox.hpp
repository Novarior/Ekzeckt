...
//             else if (charTyped != 8 && charTyped != 13 && (this->limit == 0 || this->text.getString().getSize() < this->limit))
//             {
//                 if (this->multiline && charTyped == 13)
//                     this->text.setString(this->text.getString() + "\n");
//                 else if (charTyped < 128) // Иначе добавляем введенный символ
//                     this->text.setString(this->text.getString() + static_cast<char>(charTyped));
//             }
//         }
...
//                 this->cursor.setPosition({this->shape.getPosition().x + 5.f, this->shape.getPosition().y + 5.f});
//             else
//             {
//                 sf::Vector2f charPos = this->text.findCharacterPos(this->text.getString().getSize());
...
//          */
//         TextBox(sf::Vector2f position, sf::Vector2f size, sf::Font &font, std::string placeholder = "", unsigned character_size = 24, unsigned character_limit = 0, bool multiline = false);
