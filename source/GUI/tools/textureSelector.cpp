...
//     if (this->sheet.getGlobalBounds().size.x > this->bounds.getGlobalBounds().size.y)
//         this->sheet.setTextureRect(sf::IntRect({0, 0}, {static_cast<int>(this->bounds.getGlobalBounds().size.x), static_cast<int>(this->sheet.getGlobalBounds().size.y)}));

//     if (this->sheet.getGlobalBounds().size.x > this->bounds.getGlobalBounds().size.x)
//         this->sheet.setTextureRect(sf::IntRect({0, 0}, {static_cast<int>(this->sheet.getGlobalBounds().size.x), static_cast<int>(this->bounds.getGlobalBounds().size.y)}));
...
//     this->hide_btn = new gui::Button(sf::Vector2f(x, y), sf::Vector2f(50.f, 50.f), text, gui::styles::buttons::btn_hide, gui::type::BUTTON);
// }
