...
//             if (this->orientation == TOOLBAR_HORIZONTAL)
//             {
//                 float width = this->padding * 2.f + this->buttons.size() * this->buttonSize + (this->buttons.size() - 1) * this->spacing;
...
//                 float height = this->padding * 2.f + this->buttons.size() * this->buttonSize + (this->buttons.size() - 1) * this->spacing;
//                 this->background.setSize({width, height});
//             }
//         }
...
//          */
//         ToolBar(sf::Vector2f position, short unsigned orientation = TOOLBAR_HORIZONTAL, float button_size = 30.f, float padding = 5.f, float spacing = 5.f);
...
//         // Button Management
//         void addButton(const std::string &key, const std::string &text, sf::Font &font, const std::function<void()> &callback = nullptr);
