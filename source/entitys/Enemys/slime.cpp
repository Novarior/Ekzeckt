...
Slime::Slime(float spawn_pos_x, float spawn_pos_y, Entity &targer_follow)
    : Entity(entityEnum::entityBehaviorClass::ebc_ENEMY, entityEnum::entityMovementState::ems_IDLE, entityEnum::entityState::es_DISABLED, entityEnum::entityDirection::ed_VOID)
{
