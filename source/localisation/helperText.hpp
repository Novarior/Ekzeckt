...
#if __MDEBUG__ == true
                BUTTON_DEBUG_ROOM_STATE = localization.getLocalizedString("BUTTONS", "LOCAL_DRS", "@Debug ROOM");
#endif
            }
        }
    };
    ...
    struct SettingsTexts
    {
        ...
        static void initializeLocalization(Language language)
        {
            ...
            if (localization.initializeLocalization(language))
            {
                ...
                TEXT_RESOLUTION = localization.getLocalizedString("SETTING_OPTIONS", "LOCAL_VAR_OFF", "@OFF");
                TEXT_RESOLUTION = localization.getLocalizedString("SETTING_OPTIONS", "LOCAL_VAR_ON", "@ON");
                TEXT_RESOLUTION = localization.getLocalizedString("SETTING_OPTIONS", "TEXT_VSYNC_DISABLE", "@vSync");
                TEXT_RESOLUTION = localization.getLocalizedString("SETTING_OPTIONS", "TEXT_VSYNC_ENABLE", "@Resolution Text");
