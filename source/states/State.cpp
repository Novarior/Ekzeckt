...
void State::reCaclulateCharacterSize() {
  IstateData->sd_characterSize_debug = mmath::calcCharSize(Iwindow.lock()->getSize(), 150);
  IstateData->sd_characterSize_game_big = mmath::calcCharSize(Iwindow.lock()->getSize(), 75);
  IstateData->sd_characterSize_game_medium = mmath::calcCharSize(Iwindow.lock()->getSize(), 85);
  IstateData->sd_characterSize_game_small = mmath::calcCharSize(Iwindow.lock()->getSize(), 95);
}
