...
void State::reCaclulateCharacterSize() {
	...
	IstateData->sd_characterSize_debug = mmath::calcCharSize(ws.x, ws.y, 150U);
	IstateData->sd_characterSize_game_big = mmath::calcCharSize(ws.x, ws.y, 75U);
	IstateData->sd_characterSize_game_medium = mmath::calcCharSize(ws.x, ws.y, 85U);
	IstateData->sd_characterSize_game_small = mmath::calcCharSize(ws.x, ws.y, 95U);
}
